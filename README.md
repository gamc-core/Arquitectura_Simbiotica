...
This repository documents parts of that architecture, its emerging runtime infrastructure and a set of publicly released structural artifacts.
...
architecture/  
Structural architecture and conceptual trajectory.

infrastructure/  
Runtime technologies derived from the architecture.

artifacts/  
Public structural artifacts produced by the system.

history/  
Public execution traces and structural milestones.
